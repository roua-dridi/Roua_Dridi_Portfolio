...
/* Slider
 * ------------------------------------------------------ */
// Pour chaque modal-popup
Array.from(document.querySelectorAll('.modal-popup')).forEach((modal) => {
  ...
  // Stopper le défilement à la fermeture du modal
  modal.addEventListener('close', () => clearInterval(interval));
});
